...
const name = defaultSettings.title || 'vue Element Admin LiYang It LiYang It' // page title
...
module.exports = {
  /* 加入PWA 支持 */
  pwa: {
    name: 'vue-element-admin-liyangit',
    themeColor: '#4DBA87',
    msTileColor: '#000000',
  ...
  devServer: {
    ...
    //     target: 'http://127.0.0.1:6060/pmsApi', // 代理目标后台地址
    //     changeOrigin: true,
    //     pathRewrite: {
    //       ['^' + process.env.VUE_APP_BASE_API]: ''
    //     }
