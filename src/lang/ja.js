export default {
  ...
  vxeTablePage: {
    ...
    text2: 'ドラッグ可能な確認メッセージボックス',
    text3: 'マスクレイヤ、ページのロックマスクレイヤ、ページノロック',
    text4: 'マスクレイヤをクリックして閉じる',
    text5: '[Esc]を押して閉じる',
    text6: 'ロックインタフェースでレイヤをマスクしない',
    text7: 'マルチウィンドウ、オーバーレイウィンドウ',
    text8: '全範囲ズーム',
    text9: 'ノーマルディスプレイ',
    text10: '仮想スクロールテーブル(列5w、行30wまでサポート可能)'
  }
}
